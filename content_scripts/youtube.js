...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.NAME=void 0;const NAME="YOUTUBE";exports.NAME="YOUTUBE";

},{}],4:[function(require,module,exports){
"use strict";var _jquery=_interopRequireDefault(require("jquery")),_lodash=_interopRequireDefault(require("lodash")),_constants=require("../constants.js"),_mutations=require("../generated/graphql/mutations.js");function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}console.log("EzRemote youtube.js was loaded!!");let callId=0;const resolverIdMap={};function injectScript(){const a=document.createElement("script");a.textContent=`
(() => {
  window.addEventListener('message', function(event) {
    if (event.source !== window) return;
    const data = event.data;
    if (data.command !== 'executeYoutubeCommand') return;
    console.log('executeYoutubeCommand', data);
    const player = document.getElementById('movie_player');
    const result = player[data.fn].apply(player, data.args);
    const id = data.id
    window.postMessage({ id, command: 'respYoutubeCommand', result }, '*');
  }, false);
